Retrieves a specified asset for a valid identifier. Supply the unique `assetId` in the path parameter, and this endpoint will respond to the corresponding asset details for the current user.
