Retrieves the details of an existing deal for a valid identifier. Supply the unique `dealId` from either a deal creation request or the deal list, and our API will return the corresponding deal details.
