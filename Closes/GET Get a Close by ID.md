Retrieves a specified close for a valid identifier. Supply the unique `closeId`, and this endpoint will respond to the corresponding close details for the current user.
