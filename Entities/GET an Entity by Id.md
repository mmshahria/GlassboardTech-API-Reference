Retrieves the details of a specified Entity for a valid identifier. Supply the unique `entityId`, and this endpoint will respond to the corresponding Entity details for the current user.
